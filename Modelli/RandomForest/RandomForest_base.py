...
df_train_scal, df_test_scal, y_train, y_test = preprocessing_diabetes(trainingData, testData,oversample=False,augment=False)
df_train_noFeat, df_test_noFeat, _, _ = preprocessing_diabetes(trainingData, testData, option='Delete',oversample=False,augment=False)
df_train_PCA, df_test_PCA, _, _ = preprocessing_diabetes(trainingData, testData, option='PCA',oversample=False,augment=False)
