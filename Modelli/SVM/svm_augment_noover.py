...
df_train_scal, df_test_scal, y_train, y_test = preprocessing_diabetes(trainingData, testData, augment=True, oversample=False)
df_train_noFeat, df_test_noFeat, _, _ = preprocessing_diabetes(trainingData, testData, option='Delete', augment=True, oversample=False) 
df_train_PCA, df_test_PCA, _, _ = preprocessing_diabetes(trainingData, testData, option='PCA', augment=True, oversample=False)
df_train_noSmok, df_test_noSmok, _, _ = preprocessing_diabetes(trainingData, testData, augment=True, oversample=False, delete_smoking=True)
